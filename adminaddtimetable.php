...
<head>
    ...
    <script type="text/javascript">
        ...
        function AjaxDemofun()
        {
            ...
            var strURL = "updatetimetableAjax.php"+"?sem="+a;
	...
	<nav class="nav navbar navbar-expand-lg bg-primary bg-opacity-75 navbar-dark sticky-top">
		...
		<div class="collapse navbar-collapse" id="menu">
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					<a href="#" class="nav-link dropdown-toggle active" id="TimeTableDropdown" data-bs-toggle='dropdown' aria-expanded='false'>
						<b>Update Time Table</b>
					</a>
					<ul class="dropdown-menu" aria-labelledby='TimeTableDropdown'>
            			...
            			<li>
            				<a class="dropdown-item disabled" href="adminaddtimetable.php">Update TimeTable</a>
            			</li>
					</ul>
				</li>
